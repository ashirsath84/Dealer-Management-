...
import DEALER_Latitude_FIELD from '@salesforce/schema/Account.New_D_GeoLocation__Latitude__s';
import DEALER_Longitude_FIELD from '@salesforce/schema/Account.New_D_GeoLocation__Longitude__s';
...
export default class DealerDetail extends NavigationMixin(LightningElement) {
    ...
    processMessage(message) {
        this.selectedDealerAccountId = message.selectedDealerAccountId; // Set the selected dealer account ID
    ...
    onDealerReviewScreenFlow() {
        const flowURL = '/flow/Rating_Dealer_Performance?Dealer_account=' + this.selectedDealerAccountId; // Construct the flow URL
