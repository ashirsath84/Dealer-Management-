...
import LEAFLET from '@salesforce/resourceUrl/Leaflet_File'; // Import static resource for Leaflet
...
export default class DealerConLocation extends LightningElement {
    ...
    processOutput({ data, error }) {
        if (data) {
            ...
            console.log('lat:' + data.fields.New_D_Geolocation__Latitude__s.value);
            console.log('longt:' + data.fields.New_D_Geolocation__Longitude__s.value);
        } else if (error) {
